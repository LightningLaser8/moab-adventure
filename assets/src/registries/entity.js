...
Registry.entities.add("ë̵͉̹́̍̕͝n̴̨͍̩̺̦̜̗͒̈́̇̀̍͊̆ť̸̡̟̣͙͔̣͙́̑̆̏͒̕i̶̯̥̙̮̐̊̀̀͘̕͜t̸͍̟̐̄͂͘͝y̴̼͉̰̮̽̿͛̆͗͠", {
  ...
  actions: {
    ...
    zaps: {
      type: "action.sequence",
      sound: "error.tone.long",
      duration: 110,
      sequence: ["zap1", "zap2", "zap3", "zap4"],
    },
    zap1: {
      type: "action.fire-bullet",
      duration: 2,
    ...
    las: {
      type: "action.multi",
      actions: ["las1", "las2", "las3", "las4", "bleed"],
      duration: 1,
    },
    beams: {
      type: "action.sequence",
      animation: "slow-outer-ring",
      sequence: ["las"],
      duration: 300,
    },
    finish: {
    ...
    yeet: {
      animation: "yeet",
      type: "action.sequence",
      sequence: ["no-move", "wait-for-ani", "damage-line", "blood", "moof", "move"],
      duration: 51,
    },
    moof: {
      type: "action.move",
    ...
    "mini-eye": {
      type: "action.summon",
      entity: "e̸̡̢͙͈͕̣͔̖̠̝̍͂̏̽͂́̓̆̍̀͂̉̈́͊y̵̛̝̿̅̓̽̂͒́̈̿e̶̖̎̈́̾͂͐͂̋̈́̆͘",
      sound: "error.tone",
      duration: 0,
      max: 16,
    },
  ...
  sequence: [
    // spawn sequence
    "#spawned=true?wait/4:stop-ai",
    "#spawned=true?wait/4:spawn",
    "#spawned=true?wait/4:exist",
    "#spawned=true?wait/4:spawne",
    "spawned",
    "start-ai",
    // escalating dashes
    "yeet",
...
Registry.entities.add("e̸̡̢͙͈͕̣͔̖̠̝̍͂̏̽͂́̓̆̍̀͂̉̈́͊y̵̛̝̿̅̓̽̂͒́̈̿e̶̖̎̈́̾͂͐͂̋̈́̆͘", {
  type: "boss",
  isMinion: true,
  name: "[][][][]",
  model: {
  ...
  actions: {
    ...
    attack: {
      ...
      sparkColour: [255, 255, 255, 255], //The colour the sparks start at
      sparkColourTo: [255, 0, 0, 55], //The colour the sparks go to
      smokeColour: [100, 100, 100, 200], //The colour the smoke starts at
      smokeColourTo: [100, 0, 0, 0], //The colour the smoke goes to
      waveColour: [255, 0, 0, 0], //The colour the wave ends at. It always starts white.
    },
    wait: {
      type: "action.generic",
      duration: 30,
    ...
    boom: {
      type: "action.sequence",
      sequence: ["stop-ai", "stop-ai", "charge", "attack"],
      duration: 34,
    },
    deamth: {
      type: "action.generic",
  ...
  sequence: ["wait", "@rnd<0.05?deamth"],
  triggers: [{ type: "trigger.action-ended", actionEnding: "deamth", actionName: "boom" }],
  team: "entity",
  health: 50,
  get trackingOffsetX() {
    return rnd(-50, 50);
