...
const col = new (class Int32Colours {
  constructor() {
    Object.freeze(this);
  }
  ...
  convert = function (something) {
    switch (typeof something) {
      case "string":
        return this.fromHex(something.substring(1).padEnd(8, "0"));
      case "number":
        return something | 0;
      case "bigint":
        return something | 0;
  ...
  fill(col) {
    col = col | 0;
    fill((col >> 24) & 0xff, (col >> 16) & 0xff, (col >> 8) & 0xff, col & 0xff);
  }
  /**@param {color} col */
  fillOn(g, col) {
    col = col | 0;
    g.fill((col >> 24) & 0xff, (col >> 16) & 0xff, (col >> 8) & 0xff, col & 0xff);
  }
  /**@param {color} col */
  stroke(col) {
    col = col | 0;
    stroke((col >> 24) & 0xff, (col >> 16) & 0xff, (col >> 8) & 0xff, col & 0xff);
  }
  /**@param {color} col */
  strokeOn(g, col) {
    col = col | 0;
    g.stroke((col >> 24) & 0xff, (col >> 16) & 0xff, (col >> 8) & 0xff, col & 0xff);
  }
  ...
  autonorm = function (obj) {
    for (const [k, v] of Object.entries(obj)) {
      if (
        ...
        obj[k] = this.fromHex(v.substring(1).padEnd(8, "0"));
